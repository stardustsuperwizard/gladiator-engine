...
Plan intake Issue #$ARGUMENTS in stardustsuperwizard/gladiator-engine.
...
gh api --paginate repos/stardustsuperwizard/gladiator-engine/issues/$ARGUMENTS/comments
```
