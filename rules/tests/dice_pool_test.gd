...
## comparison, a DiceProfile.match_symbol round trip through .tres, and
## spec §7.3's target-number resolution -- roll_dice(), count_at_or_above(),
## and target_modifier() across the attack and save charts' different
## magnitudes.
##
