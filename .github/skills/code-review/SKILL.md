...
name: code-review
description: >-
  Repository conventions and architecture constraints for Gladiator Engine,
  a Godot 4 rules engine for turn-based hex grid combat. Use whenever reviewing a pull
...
# Gladiator Engine code review

Gladiator Engine is a Godot 4 rules engine for turn-based hex grid combat.
...
Path-scoped rules for `rules/**` (the combat ruleset) live in
`.github/instructions/rules.instructions.md` and apply automatically when a
diff touches that directory — do not restate them here.
